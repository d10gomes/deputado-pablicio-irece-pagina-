  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#022873]/90 backdrop-blur-md border-b border-white/10">
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between px-5 py-3 text-white">
        <span className="font-display font-extrabold tracking-tight text-base sm:text-lg">
          {candidato.nome.toUpperCase()}
        </span>
        <button
          onClick={openModal}
          className="flex items-center gap-2 bg-[#f2cb05] text-[#022873] font-display font-bold text-sm px-4 py-2 rounded-full hover:brightness-95 transition shadow-md shadow-black/10"
        >
          Vote
