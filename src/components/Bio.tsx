  ...
  return (
    <section className="bg-[#f6f8fa] py-12 sm:py-16 md:py-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-5">
        ...
        <h2 className="font-display font-extrabold text-2xl sm:text-3xl md:text-4xl mb-6 sm:mb-10 text-center leading-tight text-[#022873]">
          {candidato.nome} nasceu na terra que quer representar.
        </h2>

        <div className="relative pl-5 sm:pl-6 space-y-4 sm:space-y-5 text-[#0e1b2a]/85 text-sm sm:text-lg border-l-2 border-[#0339a6]/20">
